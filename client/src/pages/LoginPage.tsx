          ...
          <div className="lg:col-span-6 max-w-md w-full mx-auto lg:mx-0">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className="w-full py-2.5 px-4 rounded-full bg-white hover:bg-stone-50 active:scale-[0.98] text-stone-800 font-bold text-xs tracking-wide shadow-md transition-all flex items-center justify-center space-x-3 border border-stone-200"
              >
